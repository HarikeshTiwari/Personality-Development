                            ...
                            for(DataSnapshot data: snapshot.getChildren()){
                                if (data.child(etPassword.getText().toString()).exists()) {
                                    ...
                                    if(activeNetwork != null){
                                        ...
                                        //getting key generated in shared preferences
                                        SharedPreferences sp=getApplicationContext().getSharedPreferences("key_generated",0);
                                        SharedPreferences.Editor editor1=sp.edit();
                                        editor1.putString("key1", String.valueOf(newRef.child("stream").getKey()));
                                        editor1.putString("key2",String.valueOf(newRef.child("first_name").getKey()));
                                        editor1.putString("key3",String.valueOf(newRef.child("first_name").getKey()));
                                        editor1.apply();
